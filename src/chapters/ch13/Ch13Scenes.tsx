...
import ConfigMap from '../../components/interactive/ch13/ConfigMap';
import ConfigBuilder from '../../components/interactive/ch13/ConfigBuilder';
import { LanguageProvider, useLanguage } from '../../i18n/LanguageContext';

export default function Ch13Scenes() {
  return <LanguageProvider><Ch13Content /></LanguageProvider>;
}

function Ch13Content() {
  const { t } = useLanguage();
